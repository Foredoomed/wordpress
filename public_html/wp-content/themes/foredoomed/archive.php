	    ...
	    <div class="postmetadata">
                <p>
                    <span class="commborder">
                        <img src="<?php bloginfo('template_directory'); ?>/images/date.png" alt="date" />
                        <?php the_time('F jS, Y') ?>
                    </span>
                    <span class="commborder">
                        <img src="<?php bloginfo('template_directory'); ?>/images/category.png" alt="category" />
                        <?php the_category(', ') ?>
                    </span>
                    <span class="commborder">
                        <img src="<?php bloginfo('template_directory'); ?>/images/author.png" alt="author" />
                        <?php the_author() ?>
                    </span>
                    <span>
                        <img src="<?php bloginfo('template_directory'); ?>/images/comment.png" alt="comment" />
